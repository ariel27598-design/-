...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col text-ink-100">
      <header className="sticky top-0 z-30 border-b border-white/10 bg-ink-950/70 backdrop-blur-md">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={toggleLang}
              className="rounded-full border border-white/15 px-3 py-1.5 text-xs font-bold text-ink-200 hover:bg-white/10"
      ...
      <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-white/10 bg-ink-950/90 backdrop-blur-md sm:hidden">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex flex-1 flex-col items-center gap-0.5 py-2 text-[11px] font-medium transition ${
                  isActive ? 'text-primary-300' : 'text-ink-400'
                }`
              }
            >
