...
export const SEED_GAMES: SeedGame[] = [
  ...
  },
  {
    ...
    name: { he: 'בגידה בבית שעל הגבעה', en: 'Betrayal at House on the Hill' },
    imageUrl: placeholderCover('Betrayal at House on the Hill'),
    description: {
      he: 'חוקרים בית רדוף באריחים שמתגלים תוך כדי משחק - עד שקורה "תפנית" ואחד השחקנים הופך לבוגד שפועל נגד השאר בתרחיש אימה ייחודי.',
      en: 'Explore a haunted house built from tiles as you go - until "the Haunt" strikes and one player turns traitor, working against the rest in a unique horror scenario.',
    },
    videoUrl: ytSearch('Betrayal at House on the Hill how to play'),
    minPlayers: 3,
    maxPlayers: 6,
    minPlaytime: 60,
    maxPlaytime: 90,
    ...
    luckVsStrategy: 3,
    cooperative: false,
    categories: ['adventure', 'night', 'strategy'],
    owned: false,
  },
  {
    id: 'link',
    name: { he: 'לינק', en: 'Link' },
    imageUrl: placeholderCover('לינק'),
    description: {
      he: 'משחק מסיבה ישראלי: חושפים מילה-מפתח ומנסים לקשר אליה כמה שיותר מילים נוספות לפני הזמן, כדי שהקבוצה תנחש את כולן.',
      en: 'An Israeli party game: reveal a key word and race the clock to link as many related words to it as possible, so your team can guess them all.',
    },
    videoUrl: ytSearch('לינק משחק קופסא איך משחקים'),
    minPlayers: 3,
    maxPlayers: 8,
    minPlaytime: 30,
    maxPlaytime: 45,
    ...
    luckVsStrategy: 2,
    cooperative: false,
    categories: ['party', 'words'],
    owned: false,
  },
  {
    id: 'guess-who',
    name: { he: 'מי זה שם?', en: 'Guess Who?' },
    imageUrl: placeholderCover('מי זה שם'),
    description: {
      he: 'כל שחקן בוחר דמות בסתר, ובתורות שואלים שאלות של כן/לא כדי לפסול דמויות ולנחש ראשונים מי הדמות של היריב.',
      en: 'Each player secretly picks a character, then takes turns asking yes/no questions to eliminate options and be first to guess the opponent\'s character.',
    },
    videoUrl: ytSearch('Guess Who how to play'),
    minPlayers: 2,
    maxPlayers: 2,
    minPlaytime: 15,
    maxPlaytime: 20,
  ...
  {
    id: 'connect-four',
    name: { he: '4 בשורה אחת', en: 'Connect Four' },
    imageUrl: placeholderCover('4 בשורה'),
    description: {
      he: 'מפילים דיסקיות צבעוניות לתוך רשת אנכית ומנסים להיות הראשונים שמסדרים ארבע דיסקיות ברצף - אופקי, אנכי או אלכסוני.',
      en: 'Drop colored discs into a vertical grid, racing to be the first to line up four in a row - horizontally, vertically or diagonally.',
    },
    videoUrl: ytSearch('Connect Four how to play'),
    minPlayers: 2,
    maxPlayers: 2,
    minPlaytime: 10,
    maxPlaytime: 15,
